...
class ScreenViewPercentage extends StatefulWidget {
  const ScreenViewPercentage({Key? key}) : super(key: key);

  @override
  State<ScreenViewPercentage> createState() => _ScreenAddAttendanceState();
}

class _ScreenAddAttendanceState extends State<ScreenViewPercentage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('View Percentage'),
        centerTitle: true,
      ),
      body: ListView(
        children: [
